package com.loyaltywork.johnsoncustomertask.utils.fetchData.repository

import android.util.Log
import com.example.authenticationmodule.AuthAPICall
import com.loyaltywork.johnsoncustomertask.BuildConfig
import com.loyaltywork.johnsoncustomertask.utils.ApplicationClass
import com.loyaltywork.johnsoncustomertask.utils.internet.Internet
        ...
        return if (Internet.isNetworkConnected()) {
            ...
            if (response.code() == 401) {
                ...
                if (AuthAPICall.run(
                        ...
                        BuildConfig.token_url,
                        BuildConfig.token_request
                    ) != null
                ) {
